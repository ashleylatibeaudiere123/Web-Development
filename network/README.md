# Network
Network is a text-based social media application, where users can create and like posts as well as follow other users.

Video demo: https://youtu.be/-q18ePdWiCY
